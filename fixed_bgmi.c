...
int is_ip_allowed(char *ip) {
    // Disallow attack on 52.140.37.168 and allow 20.204.16.238
    if (strcmp(ip, "52.140.37.168") == 0) {
...
int main(int argc, char *argv[]) {
    ...
    if (!is_ip_allowed(argv[1])) {
        printf("Attack on IP %s is blocked.\n", argv[1]);
        exit(1);
    }
